...
/**
 * Класс, осуществяющий внедрение зависимостей в любой объект,
 * содержащий поля, помеченные как @AutoInjectable
 */
...
class Injector<T> {
    ...
    /**
     * Метод, инициализирующий поля с @AutoInjectable получаемого объекта
     * в соответствии с файлом injector.properties.
     * @param obj Исходный объект.
     * @return Возвращает obj с инициализированными полями.
     */
